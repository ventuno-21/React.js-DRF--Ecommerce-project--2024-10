...
SECRET_KEY = 'django-insecure-qj)ktw=_rac64(8xps4we@xbw^m_rnts%lk@_k@ztpg118c#gv'
...
#     'MAILGUN_SENDER_DOMAIN' :env('ANYMAIL_MAILGUN_SENDER_DOMAIN'),
# }
...
# JAZZMIN library is used for jazz up the admin panel
JAZZMIN_SETTINGS = {
    'site_title': 'VENTUNO',
    'site_header': 'ventuno site header in jazzmin library',
    'site_brand': 'ventuno brand by jazzmin library',
    'copyright': 'Ventuno 2024 ',
