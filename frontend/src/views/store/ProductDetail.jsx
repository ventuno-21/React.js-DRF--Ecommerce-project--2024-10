...
function ProductDetail() {
    ...
    const handleQtyChangeValue = (event) => {
                        ...
                        <div className="row gx-lg-5">
                                        ...
                                        <div className="col-12 col-lg-12">
                                            <div className="lightbox">
                                                <img
                                                    ...
                                                    alt="Gallery image 1"
                                                    className="ecommerce-gallery-main-img active w-100 rounded-1 shadow"
                                                />
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        {gallery?.map((g, index) => (
                                            <div className="p-3" key={index}>
                                                <img
                                                    ...
                                                    alt="Gallery image 1"
                                                    className="ecommerce-gallery-main-img active shadow w-100 rounded-1"
                                                />
                                            </div>
                                        ))}
                            ...
                            <div className="col-md-6 mb-4 mb-md-0">
                                ...
                                <div>
                                    ...
                                    <p className="text-muted d-flex justify-content-left">
                                        {product.description}
                                    </p>
                                        ...
                                        <div className="row flex-column">
                                            ...
                                            <div className="col-md-6 mb-4">
                                                <div className="form-outline">
                                                    <label className="form-label" htmlFor="typeNumber"><b></b></label>
                                                    <input
                                                        type="number"
                                                        id="typeNumber"
                                                    ...
                                                    <div className='d-flex'>
                                                        {color?.map((c, index) => (
                                                            <div key={index}>
                                                                ...
                                                                <button type='button'
                                                                    className='btn p-3 me-2 color_button shadow'
                                                                    style={{ backgroundColor: `${c.color_code}` }}
                                                                    onClick={handleColorButtonClick}></button>
                                                            </div>
                                                        ))}
